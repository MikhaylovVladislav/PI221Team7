...
<h1 style="color:#FFFF00" >Калькулятор - нахождение площади равностороннего треугольникdsadsadа!</h1>
    <form action="${pageContext.request.contextPath}/JavaCalc" method="post">
        <label for="first" style="color:#FFFF00" >Введите сторону равностороннего треугольника а в миллиметрах:</label>
    ...
    <p align="right" style="color:#FF4500"><b>3)Bogolubov Maximsdfsdaf<b></p>
